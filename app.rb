...
$deck_id = nil
$isGame = false
$word_list = ["Uranium","Arme","Pouvoir","Jockey","Tableau","beurre","potage","pomme", "poire", "train", "citron", "avocat","cuisine",
"chapeau", "oranges","langue","chut","voile","blondinnet","photographe","graphiste","processing",
   "rouge","vernis","voiture","bouche","amitie","bijoux","joyeux","planant","evasif",
   "hilarant","bonnet","rire","pantalon","echarpe","saleté","jeu","Donald","Marsupilami",
   "Barbapapa","code","mort"]
$word = ""
$isPendu = false
$penduE = 7
